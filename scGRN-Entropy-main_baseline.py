...
from getMST_baseline import getmst_bseline
...
def main(FolderName, data_path, save_path):
    ...
    getmst_bseline(adata, FolderName, save_path, neighborsNumber, 0.3)

pandas2ri.activate()
# 导入R的base包
base = importr('base')
# 指定文件夹路径
data_path = 'D:/A_study/A_study/cell_differentiation2/code/data/baseline/'
result_path = "D:/A_study/A_study/cell_differentiation2/code/result/baseline/"
# 获取文件夹中所有.rds文件
